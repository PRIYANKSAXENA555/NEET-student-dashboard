    ...
    if selected_student:
        ...
        if not btest_results and not grand_test_results and not brtest_results:
            ...
            if regular_tests:
                ...
                # Target lines - Physics 50% (90), Chemistry 60% (108), Biology 70% (252)
                fig_marks.add_hline(y=90, line_dash="dash", line_color="#3498DB", opacity=0.5, annotation_text="Physics 50% (90)")
